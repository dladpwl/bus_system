...
<body>
	...
	<section>
		<p>건의사항</p>
		<div class="container" style="margin-left: auto; margin-right: auto; width: 90%; margin-top: 60px; border-bottom: 4px solid #01428c">
			<h3 style="margin-bottom: 20px; text-align: center; font-weight: bold;"> 건의사항 글쓰기 </h3>
    	</div>
		
		<div class=container style="width: 100%; margin-top: 40px;">
			<form role="form" action="/suggestion/register" method="post">
			  <table style="margin-bottom: 40px;">
				<tbody>
				  <tr>
				    <td colspan="1" style="border-bottom:1px solid #dddddd;"><label>제목</label></td>
				    <td colspan="6" style="border-bottom:1px solid #dddddd;"><input class="form-control" name='title'></td>
				  </tr>
				  <tr>
				    <td colspan="1" style="border-bottom:1px solid #dddddd;"><label>작성자</label></td>
				    <td colspan="5" style="border-bottom:1px solid #dddddd;"><input class="form-control" name='writer'></td>
				  </tr>
				  <tr>
				    <td colspan="1" style="border-bottom:1px solid #dddddd;"><label>내용</label></td>
		            <td colspan="5" style="border-bottom:1px solid #dddddd;"><textarea class="form-control" rows="20" name='content'></textarea></td>
				  </tr>
				</tbody>
			  </table>
